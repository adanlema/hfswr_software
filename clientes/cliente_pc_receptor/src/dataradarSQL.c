...
int datadbStore(datadb_t db, dataradar_t dr, int size_blob) {
    ...
    sqlite3_bind_text(stmt, 1, dr->pulse_time, DATATYPE_SIZE, SQLITE_STATIC);
    sqlite3_bind_text(stmt, 2, dr->origin, DATATYPE_SIZE, SQLITE_STATIC);
    sqlite3_bind_int(stmt, 3, dr->fc);
    sqlite3_bind_int(stmt, 4, dr->fs);
    sqlite3_bind_text(stmt, 5, dr->format, DATATYPE_SIZE, SQLITE_STATIC);
    sqlite3_bind_blob(stmt, 6, dr->data, size_blob, SQLITE_STATIC);
